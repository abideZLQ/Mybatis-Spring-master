...
<html>
    ...
    <script type="text/html" id="toolbarDemo">
        <div class="layui-btn-container">
            ...
            <button class="layui-btn" lay-event="selDel">删除选中角色</button>
        </div>
    </script>
    ...
    <script>
        layui.use(['element','laydate','form','layer','upload','laypage','table','carousel'], function () {
            ...
            table.render({
                ...
                ,cellMinWidth:100
                // 设置数据接口
                ,url: '${webPath}/role/getRoleList.do'
            ...
            function jumpUserInfo(roleId){
                layer.open({
                    ...
                    // 宽高
                    area: ['1000px', '600px'],
                    content: "${webPath}/role/jumpRoleInfo.do?id="+roleId
                });
            }
            ...
            function delUserInfo(){
                $.ajax({
                    url: "${webPath}/role/delRoleInfo.do",
                    type: "post",
