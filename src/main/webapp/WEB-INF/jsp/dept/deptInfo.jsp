    ...
    <body>
        ...
        <div class="layui-form news_list">
            <div style="margin: 20px;">
                <form class="layui-form layui-form-pane" id="form" method="post" lay-filter="example" action="${webPath}/dept/saveDeptInfo.do">
    ...
    <script>
        ...
        var setting = {
            ...
            async: {
                ...
                enable: true,
                // Ajax 获取数据的 URL 地址
                url: "${webPath}/dept/getDeptTree.do?parentid=${permissions.parentid}"
            },
            callback: {
